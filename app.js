...
app.use(session({
  ...
  secret: 'generallocation',saveUninitialized: true,resave: false}));
...
routers.forEach(function (route){
  ...
  let logicObject = (require(logic));

  let routeSetter = route.routeSetter;
  console.log(routeSetter)
  var routeSetterObject = require(routeSetter);

  console.log(routeSetterObject);

  routeSetterObject.setDefault(router, logicObject)
